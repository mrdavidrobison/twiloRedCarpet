exports.handler = function(context, event, callback) {
  ...
  switch (event.Digits) {
    case '1': // Manhattan Beach
      ...
      twiml.play('https://labored-passenger-8620.twil.io/assets/Red_Carpet_Car_Wash_Connect_To_ManhattanBeach.mp3');
      twiml.dial('+13105461693');
      break;
    case '2': // Canoga Park
      // twiml.say('I will connect you to our Canoga Park location now.');
      twiml.play('https://labored-passenger-8620.twil.io/assets/Red_Carpet_Car_Wash_Connect_To_CanogaPark.mp3');
      twiml.dial('+18188880115');
      break;
    case '3': // Thousand Oaks
      // twiml.say('I will connect you to our Thousand Oaks location now.');
      twiml.play('https://labored-passenger-8620.twil.io/assets/Red_Carpet_Car_Wash_Connect_To_ThousandOaks.mp3');
    ...
    case '0': // Feedback Voicemail
      ...
      twiml.play('https://labored-passenger-8620.twil.io/assets/Red_Carpet_Car_Wash_Leave_A_Message.mp3');
      twiml.record({
